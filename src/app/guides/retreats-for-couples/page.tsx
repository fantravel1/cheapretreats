  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        <img src={guideImages["retreats-for-couples"]} alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-rose-900/80 via-rose-800/60 to-warm-50" />
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-rose-100 leading-relaxed max-w-xl mx-auto">
